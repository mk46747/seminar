...
namespace NannyApp.DAL.Mappings
{
    class CooperationMap: ClassMap<Cooperation>
    {
        public CooperationMap()
        {
            ...
            References(b => b.CooperationInitiator).Column("CooperationInitiatorId").Not.LazyLoad();
            References(b => b.CooperationAcceptee).Column("CooperationAccepteeId").Not.LazyLoad();
            References(b => b.Offer).Column("OfferId").Not.LazyLoad();
